...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.3]{figs/domain_model.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{figs/flow-diagram.png}
...
The user screen mock-ups were made with \href{https://www.figma.com}{Figma} and illustrates the initial design of the poll application.
