...
It is a full-stack application that allows registered users to create, delete, and vote on polls.
 ...
 \begin{table} [h]
     \centering
        \begin{tabular}{|l|l|l|}
            ...
            \hline
            CI/CD & Github Actions & Software development workflow \\
            \hline
        \end{tabular}
